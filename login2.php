...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="asset/private_style/style2.css">
    <link rel="stylesheet" href="asset/sweetalert/dist/sweetalert2.min.css">
      <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">

    <title>Aplikasi Klinik & Apotek | Login</title>
  </head>
  <body>
  	<div class="container">
  		<div class="row">
  			<div class="welcome col-lg-8">
  				SELAMAT DATANG DI APLIKASI KLINIK & APOTEK
  			</div>
            ...
            <div class="mdl-card__title" style="text-align: center; border: 0; ">
	    		  ...
	    		  <h6>Mohon login terlebih dahulu</h6>
  				  <div class="form-group">
  				    ...
  				    <input type="email" class="form-control" id="username" placeholder="username" autofocus="">   <span class="fas fa-user"></span>
  				  </div>
  				  <div class="form-group">
