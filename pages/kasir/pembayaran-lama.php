...
$total_lab = 0;
     $tot_bayar_lab = 0;
                $tgl_sekarang = date('Y-m-d');
                $nomor = 1;
                $query_labor = "SELECT tbl_labordetail.*, tbl_labordetail.kd_labor,tbl_labordetail.kd_labor, tbl_labor.no_daftar,tbl_labor.nm_dokter, data_labor.kd_labor, data_labor.nama_labor FROM tbl_labordetail
...
$total_lab = $datalab['hrg_labor'];
      ...
      $tot_bayar_lab += $total_lab;
            ...
            ?>
                <tr>
                    <td><?php echo $nomor++; ?></td>
                    <td><?php echo $datalab['no_labor']; ?></td>
                    <td><?php echo $datalab['nm_dokter']; ?></td>
                    <td><?php echo $datalab['nama_labor']; ?></td>
