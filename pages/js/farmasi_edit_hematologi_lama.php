                    ...
                    <div class="row data-pengobatan">
                        <div class="position-relative form-group col-md-4">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-sm" id="no_lab" name="no_lab" value="<?php echo $nopen; ?>" >
...
<!--  $query_tampil = "SELECT * FROM tbl_nama_hematologi  WHERE status = 'aktif' ORDER BY nama_hematologi ASC";
 -->
     ...
     <label for="nama_hematologi" class="">Stok</label>
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="stk_obat" name="stk_obat" placeholder="masukkan stok hematologi" autofocus="" value="<?php echo $data['stk_obat']; ?>">
                                </div>
                        </div>
                    ...
                    <div class="row kotak-form-tabel-hematologi">
                        <div class="col-md-3 kotak-form-obat-terjual" style="display: ;">
                            ...
                            <!-- <form action="javascript:void(0);">  -->
                                ...
                                <div class="position-relative form-group">
                                    <label for="jml_obat" class="">Hasil</label>
                                    <div class="input-group input-group-sm">
                    ...
                    <div class="text-right tombol-kanan">
                        <input type="submit" name="simpan_hematologi" id="simpan_hematologi" class="btn btn-info" value="Simpan">
                    </div>
                </form>
            </div>
        </div>
